...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE} ${MAKE_OPTIONS} -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/A05_VSRotate.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/VSRotate.o: VSRotate.asm  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} dummy.d -e "Z:/LAB_MPLAB_X/LAB_MPLAB_X/A05_VSRotate/VSRotate.ERR" $(SILENT) -c ${MP_AS} $(MP_EXTRA_AS_PRE) -d__DEBUG -d__MPLAB_DEBUGGER_PICKIT2=1 -q -p$(MP_PROCESSOR_OPTION)  $(ASM_OPTIONS)   \"Z:/LAB_MPLAB_X/LAB_MPLAB_X/A05_VSRotate/VSRotate.asm\" 
	@${MV}  Z:/LAB_MPLAB_X/LAB_MPLAB_X/A05_VSRotate/VSRotate.O ${OBJECTDIR}/VSRotate.o
	@${MV}  Z:/LAB_MPLAB_X/LAB_MPLAB_X/A05_VSRotate/VSRotate.ERR ${OBJECTDIR}/VSRotate.o.err
	@${MV}  Z:/LAB_MPLAB_X/LAB_MPLAB_X/A05_VSRotate/VSRotate.LST ${OBJECTDIR}/VSRotate.o.lst
	@${RM}  Z:/LAB_MPLAB_X/LAB_MPLAB_X/A05_VSRotate/VSRotate.HEX 
...
${OBJECTDIR}/VSRotate.o: VSRotate.asm  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/VSRotate.o.d 
	@${RM} ${OBJECTDIR}/VSRotate.o 
	@${FIXDEPS} dummy.d -e "Z:/LAB_MPLAB_X/LAB_MPLAB_X/A05_VSRotate/VSRotate.ERR" $(SILENT) -c ${MP_AS} $(MP_EXTRA_AS_PRE) -q -p$(MP_PROCESSOR_OPTION)  $(ASM_OPTIONS)   \"Z:/LAB_MPLAB_X/LAB_MPLAB_X/A05_VSRotate/VSRotate.asm\" 
	@${MV}  Z:/LAB_MPLAB_X/LAB_MPLAB_X/A05_VSRotate/VSRotate.O ${OBJECTDIR}/VSRotate.o
	@${MV}  Z:/LAB_MPLAB_X/LAB_MPLAB_X/A05_VSRotate/VSRotate.ERR ${OBJECTDIR}/VSRotate.o.err
	@${MV}  Z:/LAB_MPLAB_X/LAB_MPLAB_X/A05_VSRotate/VSRotate.LST ${OBJECTDIR}/VSRotate.o.lst
	@${RM}  Z:/LAB_MPLAB_X/LAB_MPLAB_X/A05_VSRotate/VSRotate.HEX 
